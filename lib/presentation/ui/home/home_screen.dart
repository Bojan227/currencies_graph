...
import 'package:currencies_graph/presentation/riverpod/currencies_provider.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final AsyncValue<List<Currency>> currencies =
        ref.watch(supportedCurrenciesProvider);
